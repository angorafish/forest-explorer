...
describe('Auth Routes', () => {
    ...
    describe('POST /auth/signup', () => {
        it('should sign up a user', async () => {
            User.create.mockResolvedValue({ id: 1, username: 'testuser', email: 'testuser@example.com' });
        ...
        it('should not sign up a user with invalid password', async () => {
            ...
            expect(res.statusCode).toEqual(400);
            expect(res.body).toHaveProperty('error', 'Password must be at least 8 characters long, contain one uppercase letter, one lowercase letter, and one number.');
        });
    });
