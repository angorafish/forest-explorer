...
describe('fetchForestData', () => {
    ...
    it('should fetch forest data and upsert forests', async () => {
        ...
        expect(axios.get).toHaveBeenCalledWith('https://apps.fs.usda.gov/arcx/rest/services/EDW/EDW_ForestSystemBoundaries_01/MapServer/0/query', {
            params: {
                where: '1=1',
                outFields: '*',
                f: 'json'
        ...
        expect(Forest.upsert).toHaveBeenCalledWith(expect.objectContaining({
            adminForestId: 1,
            region: 'Region 1',
            forestNumber: 123,
            forestOrgCode: 'ORG123',
